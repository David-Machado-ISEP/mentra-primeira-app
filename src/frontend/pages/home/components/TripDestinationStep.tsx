  ...
  return (
    <main className="ob-setup-page ob-trip-destination-page">
      <header className="ob-trip-destination-topbar">
        ...
        <h1 id="trip-destination-title">Onde vais explorar?</h1>
      </header>
      ...
      >
        ...
        <div className="ob-trip-destination-card">
          ...
          <div className="ob-trip-location-row">
            <button
              type="button"
            ...
            {!canUseCurrentLocation && (
              <p className="ob-trip-location-hint">
                Ainda estamos a identificar a tua localização.
              </p>
            )}
          </div>
